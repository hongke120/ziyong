...
clear
echo -e " "
echo -e "\033[31m 使用前记得先备份数据，以免出现其他情况丢失数据！ \033[0m"
echo -e " "
echo -e "\033[32m 赞助商ADS: \033[0m"
echo -e "\033[32m 红客科技：www.hongke123.com \033[0m"
echo -e " "
echo -e " "
sleep 5s
...
update_panel(){
    ...
    if [ $dsize -lt 10240 ];then
        echo "获取更新包失败，请到博客反馈：https://www.hongke123.com"
        exit;
    fi
...
update_end(){
    ...
    echo -e " "
    echo -e "\033[31m 若在使用中发现问题，请到博客反馈：www.hongke123.com \033[0m"
    echo -e " "
    echo -e "\033[32m 赞助商ADS: \033[0m"
    echo -e "\033[32m 红客科技：www.hongke123.com \033[0m"
    echo -e " "
    echo -e "\033[33m 安装完刷新面板！ \033[0m"
    echo -e " "
}
