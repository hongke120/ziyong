...
clear
echo -e " "
echo -e "\033[31m 使用前记得先备份数据，以免出现其他情况丢死数据！ \033[0m"
echo -e " "
echo -e "\033[32m 赞助商红客科技: \033[0m"
echo -e "\033[32m 服务器特价：https://www.hongke123.com/ \033[0m"
echo -e "\033[32m 官网:https://www.hongke123.com/ \033[0m"
echo -e " "
echo -e "\033[33m 脚本用于测试！！！ \033[0m"
...
if [ ! -d /www/server/panel/BTPanel ];then
	...
	echo "5.9平滑升级到6.0的命令：curl https://raw.githubusercontent.com/hongke120/ziyong/main/update_to_6.sh|bash"
	exit 0;
fi
...
echo -e " "
echo -e "\033[33m 脚本用于测试！！！！ \033[0m"
echo -e "\033[33m 安装结束**刷新面板使用！！！ \033[0m"
echo -e " "
